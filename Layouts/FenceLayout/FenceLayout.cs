...
namespace Castrimaris.FenceLayout {
    //TODO move in a different namespace
    /// <summary>
    /// A <see cref="Component"/> copied from somewhere that is useful for fence layouts and placing.
    /// </summary>
        ...
        public int GetAddPointIdx() {
            ...
            if (FencePoints.Count == 0) {
                ...
                if (closestIdx == 0) {
                    ...
                    if (Vector3.Dot(addPos - FencePoints[FencePoints.Count - 1],
                            FencePoints[FencePoints.Count - 2] - FencePoints[FencePoints.Count - 1]) > 0) {
